...
class FunctionsTest < Minitest::Test
  def test_lit
    ...
    assert_lit "\"hello\"", Polars.lit("hello".dup.force_encoding("US-ASCII"))
    assert_lit "\"hello\"", Polars.lit("hello".dup.force_encoding("ASCII-8BIT"))
    assert_lit "\"hello\"", Polars.lit("hello".b)
    assert_lit "b\"\\xff\\xfe\"", Polars.lit("\xFF\xFE".b)
